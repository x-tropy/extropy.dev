...
<template>
  <div class="section bg-forrest">
    <div class="grid grid-cols-10 gap-4 text-midnight">
      <div class="col-span-8 font-serif text-lg lg:text-xl bg-grass rounded-2xl rounded-br-none px-10 lg:px-20 leading-relaxed py-14">
    ...
    <div class="grid grid-cols-10 gap-4 relative">
      ...
      <div class="col-span-6 bg-grass rounded-bl-2xl rounded-br-2xl corner-quote p-8 pt-0 ">
